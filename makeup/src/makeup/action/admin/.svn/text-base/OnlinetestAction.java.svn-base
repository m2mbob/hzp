...
import makeup.model.Onlinetest;
import makeup.service.OnlinetestService;
...
public class OnlinetestAction extends ActionSupport{
	...
	private OnlinetestService onlinetestService = new OnlinetestService();
	...
	public List<Onlinetest> getList() {
		return list;
	}
	public void setList(List<Onlinetest> list) {
		this.list = list;
	}
	public int getId() {
		return id;
